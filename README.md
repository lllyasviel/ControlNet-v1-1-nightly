...
You can see that the prompt is "a handsome man" but the model does not paint "a handsome man" on that tree leaves or the hand ares. Instead, it recognizes the tree leaves and hands and paint accordingly.
